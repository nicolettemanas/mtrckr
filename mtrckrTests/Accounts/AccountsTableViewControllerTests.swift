...
class AccountsTableViewControllerTests: QuickSpec {
    ...
    override func spec() {
        beforeEach {
            let transDataSource: TransactionsListDataSourceProtocol? = StubMTResolvers.shared.container
                .resolve(TransactionsListDataSource.self, name: "stub", argument: TransactionsFilter.byAccount)!
            self.accountsVC = MTResolver.shared.accounts.resolve(AccountsTableViewController.self, argument: transDataSource)
