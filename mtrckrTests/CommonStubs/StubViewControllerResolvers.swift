...
class StubViewControllerResolvers: ViewControllerResolvers {
    override init() {
        ...
        container.register(BillsTableViewController.self, name: "stub") { (resolver, dataSource: BillsDataSourceProtocol)  in
            BillsTableViewController.initWith(dataSource: dataSource,
                                              emptyDataSource: EmptyBillsDataSource(),
                                              newBillPresenter: resolver.resolve(NewBillPresenter.self, name: "mock")!,
...
//        container.register(BillsTableViewController.self, name: "mock") { resolver  in
//            MockBillsTableViewController.initWith(dataSource: resolver.resolve(BillsDataSource.self, name: "mock",
//                                                                               argument: "MockBillsTableViewController")!,
//                                                  emptyDataSource: EmptyBillsDataSource(),
//                                                  newBillPresenter: resolver.resolve(NewBillPresenter.self, name: "mock")!,
//                                                  deleteBillPresenter: resolver.resolve(DeleteBillPresenter.self, name: "mock")!,
//                                                  presenter: resolver.resolve(BillsPresenter.self, name: "mock")!)
...
//        }
        ...
        container.register(NewBillPresenter.self, name: "mock") { _ in
            MockNewBillPresenter()
        }
        ...
        container.register(DeleteBillPresenter.self, name: "mock") { _ in
            MockDeleteBillPresenter()
        }
        
        container.register(BillsPresenter.self, name: "mock") { resolver in
            MockBillsPresenter(interactor: resolver.resolve(BillsInteractor.self,
                                                            name: "stub",
