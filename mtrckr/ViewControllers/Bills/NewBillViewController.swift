...
class NewBillViewController: MTFormViewController {
    ...
    struct LocalizedStrings {
        ...
        static let kThisBill    = NSLocalizedString("This bill only",
                                comment: "Spiel telling the user to proceed edit of the current bill only.")
        ...
        struct Form {
            ...
            static let postDate = NSLocalizedString("Post-due date reminder",
                            comment: "Title for post-due date reminder")
        }
    }
