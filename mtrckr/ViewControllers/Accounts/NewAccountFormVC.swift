...
class NewAccountFormVC: MTFormViewController {
    ...
    struct LocalizedStrings {
        static let title            = NSLocalizedString("New Account", comment: "Title of the page when creating a new account")
        struct Form {
            ...
            static let color        = NSLocalizedString("Account Color", comment: "Title for selecting a color for an account")
        }
    }
