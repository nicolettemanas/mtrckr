...
class PayBillViewController: MTFormViewController {
    ...
    private struct LocalizedStrings {
        ...
        static let accnt   = NSLocalizedString("Using Account",
                                               comment: "Label for 'Using account' indicating w/c account to use")
        static let myAcc   = NSLocalizedString("My Accounts", comment: "Title for list of accounts")
        static let slctAcc = NSLocalizedString("Select account",
